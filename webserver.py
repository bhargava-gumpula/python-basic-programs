...
def home(name='home-page'):
    ...
    <a href='sign-up'>click here to sign up</a><br><br>
    <a href='game'>click here to play a game</a>
    <img src="avatar.png" alt="Avatar" style="width:200px"''')

@route('/sign-up')
def sign_up(name='sign-up'):
  return template('''<html>
  <head><title>Sign Up</title></head><style>body {
...
def login(name='login'):
  return template('''<form action='/' methon='get'>
  <h2>Log in<h2>
  ...
  <a href="sign-up">Click here to sign up</a></form>''')
...
@route('bhargava/projects/led/leds-on')
def leds(name='leds'):
   turn_leds(False)
